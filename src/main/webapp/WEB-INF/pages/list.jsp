...
<div class="container">
    ...
    <form id="form" method="post" action="${pageContext.request.contextPath}/user/deleteSelect">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${pageBean.list}" varStatus="v" var="u">
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm"
                           href="${pageContext.request.contextPath}/user/findById?id=${u.id}">修改</a>&nbsp;
                        <a class="btn btn-default btn-sm" href="javascript:void(0);"
                           onclick="deleteItem(${u.id});">删除</a>
                    </td>
                </tr>
            </c:forEach>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <c:if test="${pageBean.currentPage > 1}">
                    <li>
                        <a href="${pageContext.request.contextPath}/user/findAll?currentPage=${pageBean.currentPage - 1}&pageSize=${pageBean.pageSize}&name=${param.name}&email=${param.email}"
                           aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                    ...
                    <c:if test="${i != pageBean.currentPage}">
                        <li><a href="${pageContext.request.contextPath}/user/findAll?currentPage=${i}&pageSize=${pageBean.pageSize}&name=${param.name}&email=${param.email}">${i}</a>
                        </li>
                    </c:if>
                </c:forEach>
